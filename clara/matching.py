...
class Matching(object):
    ...
    def __init__(self, ignoreio=False, ignoreret=False, verbose=False, debugvar=None, bijective=True):
    ...
    def match_programs(self, P, Q, inter, ins=None, args=None, entryfnc=None, timeout=500):
